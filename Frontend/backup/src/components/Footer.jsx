  ...
  return (
    <footer className="bg-slate-100 border-t border-slate-200/50 py-12 px-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
        ...
        <div>
          <h4 className="font-headline font-bold text-emerald-800 mb-4 text-xs uppercase tracking-widest">Portals</h4>
          <ul className="space-y-2 text-xs uppercase tracking-widest font-['Inter']">
            <li><a className="text-slate-500 hover:text-emerald-700 underline decoration-2 underline-offset-4 transition-all" href="/dashboard">Retailer Portal</a></li>
            <li><a className="text-slate-500 hover:text-emerald-700 underline decoration-2 underline-offset-4 transition-all" href="/agent">Agent Portal</a></li>
            <li><a className="text-slate-500 hover:text-emerald-700 underline decoration-2 underline-offset-4 transition-all" href="/admin">Admin Portal</a></li>
          </ul>
        </div>
        <div>
