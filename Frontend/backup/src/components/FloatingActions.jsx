...
export default function FloatingActions() {
  return (
    <div className="fixed bottom-8 right-8 flex flex-col-reverse items-center gap-4 z-50">
      ...
      <Link to="/upload" className="bg-white rounded-full p-4 flex items-center justify-center text-emerald-800 shadow-2xl hover:scale-110 active:scale-90 transition-all group relative border border-emerald-100">
