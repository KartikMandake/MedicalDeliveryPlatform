  ...
  return (
    <aside className="fixed left-0 top-0 h-full flex flex-col p-4 border-r border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 w-64 font-['Inter'] text-sm font-medium z-40">
      ...
      <nav className="flex-1 space-y-1">
        <a className="flex items-center gap-3 bg-emerald-100/50 dark:bg-emerald-900/20 text-emerald-800 dark:text-emerald-200 rounded-lg px-4 py-2 transition-all duration-200 ease-in-out" href="#">
          <span className="material-symbols-outlined">dashboard</span>
          <span>Dashboard</span>
        </a>
        <a className="flex items-center gap-3 text-slate-600 dark:text-slate-400 px-4 py-2 hover:bg-slate-200/50 dark:hover:bg-slate-800/50 transition-all duration-200 ease-in-out" href="#">
      ...
      <div className="mt-auto pt-6 border-t border-slate-200/50 dark:border-slate-800/50 space-y-1">
        ...
        <a className="flex items-center gap-3 text-slate-600 dark:text-slate-400 px-4 py-2 hover:bg-slate-200/50 transition-all duration-200 ease-in-out" href="#">
