export default function ProductsFloatingActions() {
  return (
    <div className="fixed bottom-8 right-8 flex flex-col items-center gap-3 z-40">
      <button className="w-12 h-12 bg-primary text-white rounded-full shadow-lg shadow-primary/20 flex items-center justify-center hover:scale-110 transition-transform">
