      ...
      <div className="flex items-center justify-between px-6 py-3 max-w-7xl mx-auto">
        <div className="flex items-center gap-8">
          ...
          <nav className="hidden md:flex items-center gap-6 font-manrope text-sm font-semibold tracking-tight">
            <Link className="text-slate-500 hover:text-emerald-600" to="#">Deliveries</Link>
            <Link className="text-slate-500 hover:text-emerald-600" to="#">Inventory</Link>
            <Link className="text-slate-500 hover:text-emerald-600" to="#">Analytics</Link>
          </nav>
        </div>
        <div className="flex items-center gap-4">
          ...
          <button className="material-symbols-outlined text-emerald-800 hover:bg-slate-50 p-2 rounded-full transition-colors" data-icon="shopping_cart">shopping_cart</button>
