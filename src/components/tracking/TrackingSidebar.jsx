  ...
  return (
    <aside className="hidden lg:flex flex-col fixed left-0 top-0 h-full py-6 w-64 border-r border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 z-40 pt-20">
      ...
      <nav className="flex-1 space-y-1">
        <a className="flex items-center gap-3 bg-emerald-100 dark:bg-emerald-900/40 text-emerald-900 dark:text-emerald-100 rounded-lg mx-2 px-4 py-3 transition-all duration-300 ease-in-out" href="#">
          <span className="material-symbols-outlined" style={{ fontVariationSettings: "'FILL' 1" }}>location_on</span>
          <span className="font-['Inter'] text-sm font-medium">Live Track</span>
        </a>
        <a className="flex items-center gap-3 text-slate-600 dark:text-slate-400 mx-2 px-4 py-3 hover:bg-slate-200 dark:hover:bg-slate-800 transition-all duration-300 ease-in-out" href="#">
