      ...
      <div className="flex justify-between items-center px-8 py-4 max-w-full mx-auto">
        <div className="flex items-center gap-8">
          ...
          <div className="hidden md:flex gap-6">
            <a className="text-slate-600 dark:text-slate-400 hover:text-emerald-700 font-['Manrope'] font-semibold tracking-tight transition-colors" href="#">Deliveries</a>
            <a className="text-slate-600 dark:text-slate-400 hover:text-emerald-700 font-['Manrope'] font-semibold tracking-tight transition-colors" href="#">Inventory</a>
            <a className="text-slate-600 dark:text-slate-400 hover:text-emerald-700 font-['Manrope'] font-semibold tracking-tight transition-colors" href="#">Prescriptions</a>
            <a className="text-slate-600 dark:text-slate-400 hover:text-emerald-700 font-['Manrope'] font-semibold tracking-tight transition-colors" href="#">Reports</a>
          </div>
        </div>
